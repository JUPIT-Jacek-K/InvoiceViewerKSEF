...
class winInvoiceView(wx.MDIChildFrame):
    def __init__(self, parent, title, xml_invoice_filename):
        ...
        self.m_toolInfo = self.m_toolBar1.AddTool( wx.ID_PRINT, _(u"Drukuj"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
        self.m_tool2 = self.m_toolBar1.AddTool( wx.ID_INFO, _(u"Informacja"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
        self.m_tool3 = self.m_toolBar1.AddTool( wx.ID_CLOSE, _(u"Zamknij"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
