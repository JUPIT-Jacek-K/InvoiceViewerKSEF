...
class winInvoiceView(wx.MDIChildFrame):
    def __init__(self, parent, title):
        ...
        self.m_statusBar1.SetStatusText( _(u"Gotowy"), 0 )
        self.vieSizer = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, _(u"label") ), wx.VERTICAL )

        self.htmlWinFa = wx.html2.WebView.New(self, wx.ID_ANY, wx.html2.WebViewDefaultURLStr, wx.DefaultPosition, wx.DefaultSize, 0, wx.html2.WebViewBackendDefault )
