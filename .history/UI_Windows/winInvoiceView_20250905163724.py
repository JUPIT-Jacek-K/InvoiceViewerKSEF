...
class winInvoiceView(wx.MDIChildFrame):
    def __init__(self, parent, title, xml_invoice_filename):
        ...
        self.m_tool1 = self.m_toolBar1.AddTool( wx.ID_PRI, _(u"tool"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
        self.m_tool2 = self.m_toolBar1.AddTool( wx.ID_ANY, _(u"tool"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
