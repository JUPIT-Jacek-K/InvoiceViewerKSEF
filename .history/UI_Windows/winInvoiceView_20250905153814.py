...
class winInvoiceView(wx.MDIChildFrame):
    ...
    def load_invoice(self, xsl_filename):
    def clickViewFa(self, event):
        xml_filename = (
            self.filePickerFa.GetPath()
        )  # "KSEF_Wzory/test/311371462_03_KSEF.xml"
        xsl_filename = "KSEF_Wzory/FA_2/styl.xsl"
