...
class class_wxdlg_const(object):
    ...
    _ICON_AUTH = 0x0500
    _ICON_NONE = 0xFF00
    _GRAPHICS_PATH = "Graphics/I"

    def __init__(self):
        #
        self._Icons = {
            0x0100: "Icons/icons2/Ask_48x48.png",
            0x0200: "Icons/icons2/Warning_48x48.png",
            0x0300: "Icons/icons2/Error_48x48.png",
            0x0400: "Icons/icons2/Info_Circle_48x48.png",
            0x0500: "Icons/icons2/Padlock_close_48x48.png.png",
        }
        ...
        self._Options = {
            self._YES: {
                "caption": "Tak",
                "wxId": wx.ID_YES,
                "icon": "Icons/icons2/Yes_24x24.png",
            },
            self._OK: {
                "caption": "OK",
                "wxId": wx.ID_OK,
            ...
            self._SAVE: {
                "caption": "Zapisz",
                "wxId": wx.ID_SAVE,
                "icon": "Icons/icons2/Save_24x24.png",
            },
            self._APPLY: {
                "caption": "Zastosuj",
                "wxId": wx.ID_APPLY,
                "icon": "Icons/icons2/Apply_24x24.png",
            },
            self._SAVEAS: {
                "caption": "Zapisz jako",
                "wxId": wx.ID_SAVEAS,
                "icon": "Icons/icons2/SaveAs_24x24.png",
            },
            self._CLOSE: {
                "caption": "Zamknij",
                "wxId": wx.ID_CLOSE,
                "icon": "Icons/icons2/Close_24x24.png",
            },
            self._HELP: {
                "caption": "Pomoc",
                "wxId": wx.ID_HELP,
                "icon": "Icons/icons2/Help_24x24.png",
            },
            self._NO: {
                "caption": "Nie",
                "wxId": wx.ID_NO,
                "icon": "Icons/icons2/No_24x24.png",
            },
            self._CANCEL: {
                "caption": "Anuluj",
                "wxId": wx.ID_CANCEL,
            ...
            self._ABORT: {
                "caption": "Porzuć",
                "wxId": wx.ID_ABORT,
                "icon": "Icons/icons2/No_Circle_24x24.png",
            },
        }
...
class frmMyMessageBox(wx.Dialog):
    def __init__(
